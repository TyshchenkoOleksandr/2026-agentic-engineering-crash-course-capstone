...
export const uk = {
  ...
  // Stage 3 copy (add-upgrades-v2, design D21) — stubs filled in task 2.1
  "item.crit.name": "",
  "item.crit.description": "",
  "item.combo.name": "",
  "item.combo.description": "",
  "item.golden-button.name": "",
  "item.golden-button.description": "",
  "item.robot.name": "",
  "item.robot.description": "",
  "item.factory.name": "",
  "item.factory.description": "",
  "item.speed-monkey.name": "",
  "item.speed-monkey.description": "",
  "item.speed-robot.name": "",
  "item.speed-robot.description": "",
  "item.speed-factory.name": "",
  "item.speed-factory.description": "",
  "shop.level": "",
  "shop.maxed": "",
  "helper.robot.label": "",
